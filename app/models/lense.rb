class Lense < ApplicationRecord
  ...
  validates :aperture_min, presence: true
  validates :aperture_max, presence: true
  validates :focal_length_min, presence: true
  validates :focal_length_max, presence: true
